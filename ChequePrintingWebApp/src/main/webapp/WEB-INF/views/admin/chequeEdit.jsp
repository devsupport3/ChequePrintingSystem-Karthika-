...
<head>
<meta charset="UTF-8">
<title>Edit Cheque Details </title>
...
<body data-ng-controller="EditChequeController">
...
<div class="container mt-5" style="max-width: 600px;">
  ...
  <div class="alert alert-success" data-ng-show="successMessage">{{ successMessage }}</div>
         ...
         <form name="editChequeForm" novalidate data-ng-submit="updateCheque()">
	...
	<input type="text" class="form-control" data-ng-model="cheque.payeeName" readonly />
        ...
        <button type="submit"  class="btn btn-primary w-100">Update Cheque</button>
    </form>
